...
class _NotificationPageState extends State<NotificationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const SecondaryAgHeaderBar(pageTitle: 'Notifications'),
          Expanded(
            child: BlocConsumer<NotificationListBloc, NotificationListState>(
              ...
              builder: (context, state) {
                ...
                return notificationList?.isNotEmpty == true
                    ? ListView.builder(
  ...
  Widget _notificationTile(NotificationNodes notificationList,
                          ...
                          : Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Image.asset(AssetImages.icTest,
                                      fit: BoxFit.cover),
                                ),
                                Expanded(
                                  child: Padding(
