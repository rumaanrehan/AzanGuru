...
final Map<String, String> urdu = {
  ...
  LanguageKey.emailAddress: "Email address",
  LanguageKey.phoneNumber: "Phone number",
  LanguageKey.confirmPassword: "Confirm Password",
  LanguageKey.resetPassword: "Reset Password",
  LanguageKey.submit: "Submit",
  LanguageKey.forgetPassword: "Forget Password"
};
